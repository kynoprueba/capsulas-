...
<body>
  ...
  <section id="topbar" class="d-none d-lg-block">
    <div class="container d-flex">
      <div class="contact-info mr-auto">
        <ul>
          <li><i class="icofont-envelope"></i><a href="mailto:contact@example.com">sonocapsulas@gmail.com</a></li>
          <li><i class="icofont-whatsapp"></i> +57 3057114295</li>
  ...
  <header id="header">
    <div class="container d-flex">
      ...
      <div class="logo mr-auto">
        <h1 class="text-light"><a href="index.html"><span>SONOCÁPSULAS</span></a></h1>
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          <li class="active"><a href="#">¿QUÉ SON?</a></li>
         ...
         -->
          <li class="drop-down"><a href="">CURSOS</a>
            <ul>
              <li><a href="#">Bandola</a></li>
              <li class="drop-down"><a href="#">Guitarra</a>
                <ul>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="container" data-aos="fade-in">
      ...
      <!--<h2>La música que quieres aprender </h2>-->
      <div class="d-flex align-items-center">
        <i class="bx bxs-right-arrow-alt get-started-icon"></i>
        <a href="#about" class="btn-get-started scrollto">Vamos a Comenzar</a>
      </div>
      <br>
      <br>
      <br>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-xl-4 col-lg-5" data-aos="fade-up">
            <div class="content">
              <h3>¿Por que escoger SONOCAPSULAS?</h3>
              <p>
                
                ¿Cansado de escuchar siempre lo mismo?
                En SONOCÁPSULAS aprende los que quieras y a tú ritmo  
              </p>
              ...
              <div class="row">
                <div class="col-xl-4 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                  <div class="icon-box mt-4 mt-xl-0">
                    ...
                    <h4>Selecciona lo que quieres aprender</h4>
                    <p>Tú creas tu propia rurta de aprendizaje</p>
                  </div>
                </div>
                <div class="col-xl-4 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
                  <div class="icon-box mt-4 mt-xl-0">
                    <i class="icofont-group-students"></i>
                    <h4>Aprende con tus amigos</h4>
                    <p>Tus amigos , tu propia banda</p>
                  </div>
                </div>
                <div class="col-xl-4 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300">
                  <div class="icon-box mt-4 mt-xl-0">
                    <i class="icofont-share"></i>
                    <h4>Comparte tu trabajo</h4>
                    <p>Comparte tu trabajo, tus video y producción musical </p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-xl-5 col-lg-6 video-box d-flex justify-content-center align-items-stretch" data-aos="fade-right">
            <a href="https://youtu.be/3a-cltEP_2k" class="venobox play-btn mb-4" data-vbtype="video" data-autoplay="true"></a>
          </div>

          <div class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5">
            <h4 data-aos="fade-up">Sobre Nosotros</h4>
            <h3 data-aos="fade-up">Descubre los mejores cursos</h3>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6" data-aos="fade-up">
            <div class="box">
              ...
              <div class="btn-wrap">
                <a href="#" class="btn-buy">Ingresa Ahora</a>
              </div>
            </div>
          </div>
  ...
  <footer id="footer">
    ...
    <div class="container d-lg-flex py-4">
      ...
      <div class="mr-lg-auto text-center text-lg-left">
        <div class="copyright">
          &copy; Copyright <strong><span>Bandolitis</span></strong>
        </div>
        <div class="credits">
